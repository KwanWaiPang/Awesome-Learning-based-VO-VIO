...
|:----:|:-----:| ----------- |:----------:|:----:|
|2025|`CVPR`|WildGS-SLAM: Monocular Gaussian Splatting SLAM in Dynamic Environments|[![Github stars](https://img.shields.io/github/stars/GradientSpaces/WildGS-SLAM.svg)](https://github.com/GradientSpaces/WildGS-SLAM)|[website](https://wildgs-slam.github.io/)|
